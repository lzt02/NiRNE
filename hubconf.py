...
def NiRNE(local_cache_dir: Optional[str] = None, device="cuda:0", yoso_version='NiRNE') -> Predictor:
    """Load the NiRNE pipeline."""
    
    yoso_weight_path = os.path.join(local_cache_dir if local_cache_dir else "adsfda", yoso_version)
